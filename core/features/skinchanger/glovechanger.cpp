	...
	if (Vars.skins.glove_model > 0) {
		...
		if (glove)
		{
			...
			case 0:
				break;
			case 1:
				apply_glove_skin(glove, GLOVE_STUDDED_BLOODHOUND, get_glove_skin(GLOVE_STUDDED_BLOODHOUND, Vars.skins.bloodhound_skin), index_blood, 3, g_wear);
				break;
			case 2:
				apply_glove_skin(glove, GLOVE_SPORTY, get_glove_skin(GLOVE_SPORTY, Vars.skins.sport_skin), index_sport, 3, g_wear);
				break;
			case 3:
				apply_glove_skin(glove, GLOVE_SLICK, get_glove_skin(GLOVE_SLICK, Vars.skins.driver_skin), index_slick, 3, g_wear);
				break;
			case 4:
				apply_glove_skin(glove, GLOVE_LEATHER_WRAP, get_glove_skin(GLOVE_LEATHER_WRAP, Vars.skins.handwrap_skin), index_leath, 3, g_wear);
				break;
			case 5:
				apply_glove_skin(glove, GLOVE_MOTORCYCLE, get_glove_skin(GLOVE_MOTORCYCLE, Vars.skins.moto_skin), index_moto, 3, g_wear);
				break;
			case 6:
				apply_glove_skin(glove, GLOVE_SPECIALIST, get_glove_skin(GLOVE_SPECIALIST, Vars.skins.specialist_skin), index_speci, 3, g_wear);
				break;
			case 7:
				apply_glove_skin(glove, GLOVE_HYDRA, get_glove_skin(GLOVE_HYDRA, Vars.skins.hydra_skin), index_hydra, 3, g_wear);
				break;
			}
