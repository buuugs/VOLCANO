...
void skinchanger::run() {
	...
	for (size_t i = 0; my_weapons[i] != 0xFFFFFFFF; i++) {
		...
		case WEAPON_USP_SILENCER:
			weapon_atr->fallback_paint_kit() = Vars.skins.paint_kit_index_usp;//() = wear;
			break;
		case WEAPON_HKP2000:
			weapon_atr->fallback_paint_kit() = Vars.skins.paint_kit_index_p2000;//() = wear;
			break;
		case WEAPON_GLOCK:
			weapon_atr->fallback_paint_kit() = Vars.skins.paint_kit_index_glock;//() = wear;
			break;
		case WEAPON_P250:
			weapon_atr->fallback_paint_kit() = Vars.skins.paint_kit_index_p250;//() = wear;
			break;
		case WEAPON_FIVESEVEN:
			weapon_atr->fallback_paint_kit() = Vars.skins.paint_kit_index_fiveseven;//() = wear;
			break;
		case WEAPON_TEC9:
			weapon_atr->fallback_paint_kit() = Vars.skins.paint_kit_index_tec;//() = wear;
			break;
		case WEAPON_CZ75A:
			weapon_atr->fallback_paint_kit() = Vars.skins.paint_kit_index_cz;//() = wear;
			break;
		case WEAPON_ELITE:
			weapon_atr->fallback_paint_kit() = Vars.skins.paint_kit_index_duals;//() = wear;
			break;
		case WEAPON_DEAGLE:
			weapon_atr->fallback_paint_kit() = Vars.skins.paint_kit_index_deagle;//() = wear;
			break;
		case WEAPON_REVOLVER:
			weapon_atr->fallback_paint_kit() = Vars.skins.paint_kit_index_revolver;//() = wear;
			break;
		case WEAPON_FAMAS:
			weapon_atr->fallback_paint_kit() = Vars.skins.paint_kit_index_famas;//() = wear;
			break;
		case WEAPON_GALILAR:
			weapon_atr->fallback_paint_kit() = Vars.skins.paint_kit_index_galil;//() = wear;
			break;
		case WEAPON_M4A1:
			weapon_atr->fallback_paint_kit() = Vars.skins.paint_kit_index_m4a4;//() = wear;
			break;
		case WEAPON_M4A1_SILENCER:
			weapon_atr->fallback_paint_kit() = Vars.skins.paint_kit_index_m4a1;//() = wear;
			break;
		case WEAPON_AK47:
			weapon_atr->fallback_paint_kit() = Vars.skins.paint_kit_index_ak47;//() = wear;
			break;
		case WEAPON_SG556:
			weapon_atr->fallback_paint_kit() = Vars.skins.paint_kit_index_sg553;//() = wear;
			break;
		case WEAPON_AUG:
			weapon_atr->fallback_paint_kit() = Vars.skins.paint_kit_index_aug;//() = wear;
			break;
		case WEAPON_SSG08:
			weapon_atr->fallback_paint_kit() = Vars.skins.paint_kit_index_ssg08;//() = wear;
			break;
		case WEAPON_AWP:
			weapon_atr->fallback_paint_kit() = Vars.skins.paint_kit_index_awp;//() = wear;
			break;
		case WEAPON_SCAR20:
			weapon_atr->fallback_paint_kit() = Vars.skins.paint_kit_index_scar;//() = wear;
			break;
		case WEAPON_G3SG1:
			weapon_atr->fallback_paint_kit() = Vars.skins.paint_kit_index_g3sg1;//() = wear;
			break;
		case WEAPON_SAWEDOFF:
			weapon_atr->fallback_paint_kit() = Vars.skins.paint_kit_index_sawoff;//() = wear;
			break;
		case WEAPON_M249:
			weapon_atr->fallback_paint_kit() = Vars.skins.paint_kit_index_m249;//() = wear;
			break;
		case WEAPON_NEGEV:
			weapon_atr->fallback_paint_kit() = Vars.skins.paint_kit_index_negev;//() = wear;
			break;
		case WEAPON_MAG7:
			weapon_atr->fallback_paint_kit() = Vars.skins.paint_kit_index_mag7;//() = wear;
			break;
		case WEAPON_XM1014:
			weapon_atr->fallback_paint_kit() = Vars.skins.paint_kit_index_xm1014;//() = wear;
			break;
		case WEAPON_NOVA:
			weapon_atr->fallback_paint_kit() = Vars.skins.paint_kit_index_nova;//() = wear;
			break;
		case WEAPON_BIZON:
			weapon_atr->fallback_paint_kit() = Vars.skins.paint_kit_index_bizon;//() = wear;
			break;
		case WEAPON_MP5_SD:
			weapon_atr->fallback_paint_kit() = Vars.skins.paint_kit_index_mp5sd;//() = wear;
			break;
		case WEAPON_MP7:
			weapon_atr->fallback_paint_kit() = Vars.skins.paint_kit_index_mp7;//() = wear;
			break;
		case WEAPON_MP9:
			weapon_atr->fallback_paint_kit() = Vars.skins.paint_kit_index_mp9;//() = wear;
			break;
		case WEAPON_MAC10:
			weapon_atr->fallback_paint_kit() = Vars.skins.paint_kit_index_mac10;//() = wear;
			break;
		case WEAPON_P90:
			weapon_atr->fallback_paint_kit() = Vars.skins.paint_kit_index_p90;//() = wear;
			break;
		case WEAPON_UMP45:
			weapon_atr->fallback_paint_kit() = Vars.skins.paint_kit_index_ump45;//() = wear;
			break;
		}
	}	
}
	...
	if (csgo::local_player)
	{
			...
			|| pData->value.m_int == iClassic))
		{
			if (Vars.skins.knife_model == 1)
				...
				pData->value.m_int = iStiletto;
			else if (Vars.skins.knife_model == 14)
				pData->value.m_int = iTalon;
			else if (Vars.skins.knife_model == 15)
				pData->value.m_int = iNomad;
			else if (Vars.skins.knife_model == 16)
				pData->value.m_int = iSkeleton;
			else if (Vars.skins.knife_model == 17)
				pData->value.m_int = iSurvival;
			else if (Vars.skins.knife_model == 18)
				pData->value.m_int = iParacord;
			else if (Vars.skins.knife_model == 19)
				pData->value.m_int = iClassic;
