...
namespace bmenu {
    ...
    namespace globals {
        ...
        static struct {
            color window_border_inner_fill{ 100, 60, 60, 255 };
            color window_border_fill{ 40, 40, 40, 255 };
            color window_border_color{ 20, 20, 20, 255 };
            color window_background{ 30, 30, 30, 255 };

            color control_outline{ 23, 23, 30, 255 };
            color control_active_or_clicked{ 51, 204, 30, 255 }; // 108, 92, 231
            color control_idle{ 62, 62, 72, 255 };

            color tab_outline{ 30, 30, 30, 255 };
            color tab_active_or_clicked{ 51, 204, 30, 255 }; // 108, 92, 231
            color tab_idle{ 30, 30, 30, 255 };


            color color_groupbox_bg{ 27, 27, 27, 255 };
    ...
    ZGUI_API bool tab_button(const char* id, const vec2 size, const bool toggled, const unsigned long font);
    ...
    ZGUI_API void opencombobox(const char* id, std::vector<std::string> items, int& value, const int size = 100);
