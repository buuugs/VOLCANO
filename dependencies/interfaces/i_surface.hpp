...
public:
	...
	{
		typedef unsigned long(__thiscall* _CreateFont)(void*);
		return call_vfunc<_CreateFont>(this, 71)(this);
	}
	...
	bool SetFontGlyphSetS(unsigned long& font, const char* windowsFontName, int tall, int weight, int blur, int scanlines, int flags)
	{
		typedef bool(__thiscall* _SetFontGlyphSet)(void*, unsigned long, const char*, int, int, int, int, int, int, int);
		return call_vfunc<_SetFontGlyphSet>(this, 72)(this, font, windowsFontName, tall, weight, blur, scanlines, flags, 0, 0);
	}
